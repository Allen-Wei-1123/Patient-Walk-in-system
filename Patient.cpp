...
Patient::Patient() {
    ...
    careCard = "0000000000";
    patient_name = "To be entered";
    patient_address = "To be entered";
    patient_phone = "To be entered";
    patient_email = "To be entered";
}
...
void Patient::setAddress(const string anAddress){
    patient_address = anAddress;
}

// Description: Sets the patient's phone.
void Patient::setPhone(const string aPhone){
    patient_phone = aPhone;
}

// Description: Sets the patient's email.
void Patient::setEmail(const string anEmail){
    patient_email = anEmail;
}
...
void Patient::resetCareCard(const string aname){
    if (aname.size()==10) {
        careCard = aname;
    }else{
        careCard = "0000000000";
